...
class CreateVolume extends StatefulWidget {
  const CreateVolume({super.key});

  @override
  State<CreateVolume> createState() => CreateVolumeState();
}

class CreateVolumeState extends State<CreateVolume> {
                ...
                child: FloatingActionButton.extended(
                    ...
                    onPressed: () {
                      ...
                      if (volumeName.isNotEmpty) {
                        userCmd = "docker volume create $volumeName";
